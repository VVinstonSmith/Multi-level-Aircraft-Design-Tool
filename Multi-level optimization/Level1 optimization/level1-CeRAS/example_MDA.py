# -*- coding: utf-8 -*-
"""
Created on Wed Mar  9 21:32:34 2022
...
CONFIGURATION_FILE = pth.join(DATA_FOLDER_PATH, "oad_process_MDA_timestep_mission.yml")
...
prob = eval_problem = oad.evaluate_problem(CONFIGURATION_FILE, overwrite=True)
om.n2(eval_problem)
