...
x31_f = interp1([GRID_shape_3(2), GRID_shape_5(2)], [GRID_shape_3(1), GRID_shape_5(1)], y3, 'linear');
x31_r = GRID_ail_1(1);
x32_f = GRID_ail_1(1);
x32_r = GRID_ail_2(1);
...
x42_f = GRID_ail_3(1);
x42_r = GRID_ail_4(1);
x5_f = interp1([GRID_shape_3(2), GRID_shape_5(2)], [GRID_shape_3(1), GRID_shape_5(1)], y5, 'linear');
x5_r = interp1([GRID_shape_4(2), GRID_shape_6(2)], [GRID_shape_4(1), GRID_shape_6(1)], y5, 'linear');
% z
...
caero(CAERO_count).P3 = [x31_f, y3, z3];
caero(CAERO_count).P4 = [x32_r, y3, z3];
...
caero(CAERO_count).id = CAERO_id_Rwing;
caero(CAERO_count).pid = PAERO_id;
caero(CAERO_count).P1 = [x31_f, y3, z3];
caero(CAERO_count).P2 = [x31_r, y3, z3];
caero(CAERO_count).P3 = [x41_f, y4, z4];
caero(CAERO_count).P4 = [x41_r, y4, z4];
caero(CAERO_count).m = m31_wing;
...
caero(CAERO_count).id = CAERO_id_Rwing;
caero(CAERO_count).pid = PAERO_id;
caero(CAERO_count).P1 = [x32_f, y3, z3];
caero(CAERO_count).P2 = [x32_r, y3, z3];
caero(CAERO_count).P3 = [x42_f, y4, z4];
caero(CAERO_count).P4 = [x42_r, y4, z4];
caero(CAERO_count).m = m32_wing;
caero(CAERO_count).n = n3_wing;
for ii = 1:length(grids_set)
    if strcmp(grids_set(ii).sub_region,'Rwing')
        caero(CAERO_count).SET_num = ii;
...
if y5>y4
    ...
    caero(CAERO_count).P3 = [x5_f, y5, z5];
    caero(CAERO_count).P4 = [x5_r, y5, z5];
    caero(CAERO_count).m = m4_wing;
