...
function [wing_box1, wing_box2, cbar_area, cquad_area, cbar, cquad, grids] = connect_wing_box_th(wing_box1, wing_box2, cbar_area, cquad_area, cbar, cquad, grids)

%% 前梁上缘条区域序号(CBAR_area)
area1_num = wing_box1.CBAR_uf_num;
area2_num = wing_box2.CBAR_uf_num;
[cbar_area,cbar, wing_box1.GRIDs_num, grids] =...
    connect_cbar_area_th(area1_num, area2_num, cbar_area, cbar, wing_box1, grids);
%% 前梁下缘条区域序号(CBAR_area)
...
[cquad_area,cquad, wing_box1.GRIDs_num, grids] =...
    connect_cquad_area_th(area1_num, area2_num, cquad_area, cquad, wing_box1, grids);
%% 后腹板区域序号(CQUAD_area)
